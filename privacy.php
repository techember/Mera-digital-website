  ...
  <div class="container">
    <div class="policy-text">
      ...
      <ul>
        ...
        <li>To execute financial transactions, settle wallet funds to bank accounts, and calculate commissions.</li>
      ...
      <p style="margin-top: 40px; font-size: 14px; color: #64748b;">Last Updated: June 12, 2026</p>
    </div>
  </div>
</section>
